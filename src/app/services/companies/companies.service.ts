...
export class CompaniesService {
  ...
  update(company: Company) {
    return this.httpClient.put(`${environment?.API_URL}/companies`, company);//consumir el api para actualizar la empresa en la base de datos
  }
  //Eliminar una empresa usando el api
  delete(id?: string) {
